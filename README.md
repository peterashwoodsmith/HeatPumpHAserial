...
For full details on code/hardware see the HeatPumpHAserial.ino code.
...
Since the zigbee chosen icons etc. are not good this overwrites that defaults and creates an 'ok'
